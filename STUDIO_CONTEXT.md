...
**⚠️ КОНФЛИКТ ID (исправить вручную через Страницу Жизни):**
- `007_FINCH` и `007_KEI` — два резидента с одним номером 007
- Кей должен получить номер `009_KEI`
- Юст остаётся `008_JUST`
