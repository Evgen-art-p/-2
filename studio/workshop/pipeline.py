...
# PATCH_CONTEXT_MODES_APPLIED · Спринт 42
...
def build_agent_context(
    ...
    # ── Определяем режим ─────────────────────────────────────
    agent_mode = _detect_agent_mode(worker_id, state)
...
async def process_agent_result(
    ...
    if worker_id == qa_agent and client_slug != "_sandbox":
        ...
        # ══ Ministry: единственный писатель CHAIN-валюты · Спринт 44 ══
...
def _sync_feedback_scores_to_dna(client_slug: str, dept: str = ""):
    ...
    for agent_id, data in agents_data.items():
        ...
        # Спринт 44 · chain-шкала (потолок 6.0):
