# studio/modules/trading/hans_live.py
# ─────────────────────────────────────────────────────────────
...
#
# Форма — близнец panikyor_live.py: живая модель + штатная память
# + язык датчика + душа города + петля обучения.
# ─────────────────────────────────────────────────────────────
...
A04_DIR      = _HERE / "A04"
PROMPT_PATH  = A04_DIR / "forge" / "prompt.md"
KNOWLEDGE    = A04_DIR / "forge" / "knowledge" / "HANS_MATH.md"   # книга Ганса (фрактал + Красная)
