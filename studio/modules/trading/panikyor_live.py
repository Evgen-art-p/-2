# studio/modules/trading/panikyor_live.py
# ─────────────────────────────────────────────────────────────
...
#
# Форма — близнец morj_live.py: живая модель + штатная память + язык датчика
# + душа города + петля обучения.
# ─────────────────────────────────────────────────────────────
...
A03_DIR      = _HERE / "A03"
PROMPT_PATH  = A03_DIR / "forge" / "prompt.md"
KNOWLEDGE    = A03_DIR / "forge" / "knowledge" / "PANIKYOR_MATH.md"   # если появится
